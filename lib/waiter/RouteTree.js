class RouteTree {
    ...
    dig(parts, shouldCreate) {
        ...
        /*
            ...
            an input corresponding to a param's index. By looking
            at the path of the found route, which has the params
            intact, we can map the keys of the args array back to
            the positions at which the params appear in the route's
            blueprint path, constructing a neat object where the
            key names match the param names.
        */
        let finalArgs = {}
        if (!shouldCreate && found) {
        ...
        return { found: found, args: finalArgs }
    }
